...
Part of the **Coltex Living Brain** — `javascript` knowledge cluster.
...
## Stats
- Category: `javascript`
- Parent: `living-brain/domains/javascript/`

Query this domain:
```bash
python3 -m brain retrieve "your question about javascript"
```
