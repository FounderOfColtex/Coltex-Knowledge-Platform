---
id: CHUNK-00869-MICROSERVICES-SAGA-PATTERN-API-REFERENCE-V165
title: "Chunk 00869 Microservices Saga Pattern \u2014 Api Reference (v165)"
category: CHUNK-00869-microservices_saga_pattern_api_reference_v165.md
tags:
- saga
- compensation
- orchestration
...
```sql
CREATE TABLE IF NOT EXISTS microservices_165 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 165,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_microservices_165_topic ON microservices_165 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM microservices_165
