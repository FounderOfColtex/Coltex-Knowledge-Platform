---
id: CHUNK-01482-CANARY-DEPLOYMENT-STRATEGIES-BENCHMARK-V278
title: "Chunk 01482 Canary Deployment Strategies \u2014 Benchmark (v278)"
category: CHUNK-01482-canary_deployment_strategies_benchmark_v278.md
tags:
- canary
- rollout
- traffic_split
...
```sql
CREATE TABLE IF NOT EXISTS ci_cd_278 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 278,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_ci_cd_278_topic ON ci_cd_278 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM ci_cd_278
