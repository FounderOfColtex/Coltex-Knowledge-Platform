---
id: CHUNK-01892-BLAMELESS-POSTMORTEM-WRITING-BENCHMARK-V188
title: "Chunk 01892 Blameless Postmortem Writing \u2014 Benchmark (v188)"
category: CHUNK-01892-blameless_postmortem_writing_benchmark_v188.md
tags:
- timeline
- root_cause
- action_items
...
spec:
  ...
  template:
    spec:
      containers:
        - name: app
          image: coltex/incidents-svc:188
          env:
            - name: TOPIC
              value: "postmortem"
```
