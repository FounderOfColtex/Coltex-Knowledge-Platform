---
id: CHUNK-02016-WEAVIATE-SCHEMA-DESIGN-BEST-PRACTICES-V312
title: "Chunk 02016 Weaviate Schema Design \u2014 Best Practices (v312)"
category: CHUNK-02016-weaviate_schema_design_best_practices_v312.md
tags:
- weaviate
- schema
- multi_tenancy
...
spec:
  ...
  template:
    spec:
      containers:
        - name: app
          image: coltex/vector_stores-svc:312
          env:
            - name: TOPIC
