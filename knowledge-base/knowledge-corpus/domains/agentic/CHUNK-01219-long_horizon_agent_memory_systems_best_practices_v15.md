---
id: CHUNK-01219-LONG-HORIZON-AGENT-MEMORY-SYSTEMS-BEST-PRACTICES-V15
title: "Chunk 01219 Long-Horizon Agent Memory Systems \u2014 Best Practices (v15)"
category: CHUNK-01219-long_horizon_agent_memory_systems_best_practices_v15.md
tags:
- episodic
- semantic
- working_memory
...
```sql
CREATE TABLE IF NOT EXISTS agentic_15 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 15,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_agentic_15_topic ON agentic_15 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM agentic_15
