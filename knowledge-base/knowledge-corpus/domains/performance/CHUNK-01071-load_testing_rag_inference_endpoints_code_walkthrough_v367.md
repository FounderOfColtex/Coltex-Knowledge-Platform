...
```sql
CREATE TABLE IF NOT EXISTS performance_367 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 367,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_performance_367_topic ON performance_367 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM performance_367
