---
id: CHUNK-01097-PII-DETECTION-IN-CODE-REPOSITORIES-BEST-PRACTICES-V393
title: "Chunk 01097 PII Detection in Code Repositories \u2014 Best Practices (v393)"
category: CHUNK-01097-pii_detection_in_code_repositories_best_practices_v393.md
tags:
- pii
- redaction
- scanning
...
```sql
CREATE TABLE IF NOT EXISTS security_393 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 393,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_security_393_topic ON security_393 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM security_393
