---
id: CHUNK-01085-DATA-LINEAGE-FOR-RAG-CORPORA-API-REFERENCE-V381
title: "Chunk 01085 Data Lineage for RAG Corpora \u2014 Api Reference (v381)"
category: CHUNK-01085-data_lineage_for_rag_corpora_api_reference_v381.md
tags:
- lineage
- provenance
- audit
...
```sql
CREATE TABLE IF NOT EXISTS data_quality_381 (
    id          BIGSERIAL PRIMARY KEY,
    topic       TEXT NOT NULL,
    variant     INTEGER NOT NULL DEFAULT 381,
    payload     JSONB NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

CREATE INDEX idx_data_quality_381_topic ON data_quality_381 (topic);

EXPLAIN ANALYZE
SELECT id, topic, payload FROM data_quality_381
